...
const GoogleIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M23.5201 12.2901C23.5201 11.4701 23.44 10.6801 23.2901 9.92006H11.9601V14.3901H18.4901C18.2301 15.9301 17.3701 17.2901 16.0501 18.2601L16.0203 18.397L19.8277 21.3653L20.0901 21.3901C22.4601 19.1901 23.8301 15.9601 23.5201 12.2901Z"
      fill="#4285F4"
    />
    <path
      d="M11.96 24.0001C15.15 24.0001 17.89 22.9201 19.95 20.9701H19.9499L15.92 17.8201C14.82 18.5901 13.43 18.9902 11.96 18.9902C8.84 18.9902 6.13 16.9201 5.15001 14.1101L5.02324 14.1206L1.10702 17.167L1.06006 17.2901C3.12006 21.4101 7.33003 24.0001 11.96 24.0001Z"
      fill="#34A853"
    />
    <path
      d="M5.15004 14.1101C4.63004 12.5601 4.63004 10.8901 5.15004 9.34005L5.14389 9.20625L1.20038 6.13013L1.11003 6.20005C-0.349969 9.09005 -0.349969 12.5001 1.11003 15.3901L5.15004 14.1101Z"
      fill="#FBBC05"
    />
    <path
      d="M11.96 5.01004C13.62 4.97004 15.23 5.58004 16.48 6.75004L19.98 3.25004C17.78 1.17004 14.92 -0.0199589 11.96 0.000141094C7.33003 0.000141094 3.12006 2.59005 1.06006 6.71005L5.15001 9.90005C6.12001 7.08005 8.83003 5.01004 11.96 5.01004Z"
      fill="#EA4335"
    />
  </svg>
);
...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        err.type === 'user_blocked' ||
        err.message?.toLowerCase().includes('blocked') ||
        err.message?.toLowerCase().includes('disabled')
      ) {
        setError(
          'Your account has been blocked by the super admin. Please contact support to get unblocked.',
        );
      } else {
        ...
        <div className="bg-[#111] bg-opacity-80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          {mfaRequired ? (
            <form
              ...
              className="space-y-6 relative z-10 animate-in fade-in slide-in-from-right-4"
            >
            ...
            <form
              ...
              className="space-y-5 relative z-10 animate-in fade-in slide-in-from-left-4"
            >
              <div className="space-y-2">
                <label className="text-xs font-medium uppercase tracking-wider text-white/50 ml-1">
                  Email Address
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#111] px-2 text-white/40 tracking-wider">
                    Or continue with
                  </span>
                </div>
              </div>
