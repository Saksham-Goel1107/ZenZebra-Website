...
export function Providers({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    ...
    const warningMessage =
      "This is a browser feature intended for developers. If someone told you to copy-paste something here to enable a feature or 'hack' someone's account, it is a scam and will give them access to your ZenZebra account.";
