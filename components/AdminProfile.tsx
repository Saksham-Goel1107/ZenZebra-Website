            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
              <div className="relative group/avatar shrink-0">
                ...
                {!isEditing && user.emailVerification && (
                  <div
                    className="absolute -bottom-2 -right-2 bg-green-500 text-black p-1 rounded-full border-2 border-card"
              ...
              <div className="flex-1 min-w-0 w-full">
                {isEditing ? (
                  <div className="space-y-4 w-full animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="pt-2">
                      ...
                      <p className="text-xs text-muted-foreground mb-1.5">
                        Required for changing sensitive info (email/phone)
                      </p>
                      <Input
                        type="password"
                        value={password}
                  ...
                  <div className="relative sm:pr-12 group flex flex-col items-center sm:block text-center sm:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold title-font text-foreground mb-1">
                      {user.name}
                    </h2>
                    ...
                    <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                      <span
                        className={`px-2.5 py-0.5 rounded-full text-xs font-medium border ${user.status ? 'bg-green-500/10 text-green-500 border-green-500/20' : 'bg-red-500/10 text-red-500 border-red-500/20'}`}
                      >
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={
                    user.mfa
                      ? 'text-xs text-green-500 font-medium px-2 py-0.5 bg-green-500/10 rounded-full border border-green-500/20'
                      : 'text-xs text-muted-foreground font-medium px-2 py-0.5 bg-muted rounded-full'
                  }
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        onClick={confirmMfa}
                        size="icon"
                        className="bg-primary hover:bg-primary/90 w-10 shrink-0 text-primary-foreground"
                      >
