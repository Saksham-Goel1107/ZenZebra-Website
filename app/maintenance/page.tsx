...
export default async function MaintenancePage() {
    ...
    const message = settings.maintenanceMessage || "We're currently upgrading our systems to provide a better experience. Please check back soon.";
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-8 text-center w-full">
                <p className="text-white/20 text-xs uppercase tracking-[0.3em]">{siteName} &copy; {new Date().getFullYear()}</p>
            </div>
