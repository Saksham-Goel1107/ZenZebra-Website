            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-[#CC2224]">
                  <div className="w-6 h-6 rounded-full bg-[#CC2224] text-white flex items-center justify-center text-xs font-bold">
                    1
                  </div>
                ...
                <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                  <p className="text-[10px] text-white/40 uppercase tracking-wider mb-2 font-bold">
                    Manual Entry Key
                  </p>
