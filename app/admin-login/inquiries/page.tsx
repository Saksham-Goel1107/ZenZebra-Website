    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-6xl mx-auto py-6 px-4">
      ...
      {loading ? (
        <div className="flex flex-col h-[40vh] items-center justify-center gap-4">
          ...
          <p className="text-xs font-black uppercase tracking-widest text-[#CC2224] animate-pulse">
            Fetching Documents...
          </p>
        </div>
        ...
        <div className="text-center py-32 bg-card/30 rounded-[3rem] border border-dashed border-border/50 backdrop-blur-xs group">
          ...
          <h3 className="text-2xl font-black uppercase italic tracking-tighter text-foreground/80">
            Inbox Clear
          </h3>
                ...
                <div className="space-y-8 flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <h3 className="font-black text-2xl leading-none uppercase italic tracking-tighter text-foreground group-hover:text-[#CC2224] transition-colors">
                          {inquiry.name}
                        </h3>
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground mt-3">
                          <a
                            ...
                            className="flex items-center gap-2 hover:text-[#CC2224] transition-all bg-muted/40 px-3 py-1.5 rounded-xl border border-transparent hover:border-[#CC2224]/20"
                          >
                    ...
                    <div className="flex flex-row sm:flex-col items-center sm:items-end gap-3 shrink-0">
                      <span
                        className={`text-[11px] font-black uppercase tracking-[0.25em] px-4 py-1.5 rounded-2xl ${STATUS_CONFIG[inquiry.status]?.bg} ${STATUS_CONFIG[inquiry.status]?.color} border border-current/10 shadow-sm`}
                      >
                ...
                <div className="flex lg:flex-col gap-4 justify-end items-center self-end lg:self-stretch lg:border-l lg:border-border/50 lg:pl-10">
                  {updatingStatus === inquiry.$id ? (
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#CC2224] animate-pulse">
                        Processing
                      </span>
                    </div>
                  ) : (
