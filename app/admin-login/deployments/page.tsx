                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        {d.target && (
                          <span className="text-xs bg-muted px-2 py-0.5 rounded">{d.target}</span>
                        )}
                      </div>
                      <div className="text-xs text-muted-foreground flex items-center gap-4">
                        <span className="flex items-center gap-1">
                          <GitBranch className="w-3 h-3" /> {d.meta.githubCommitRef}
                        </span>
                        <span className="flex items-center gap-1">
                          <GitCommit className="w-3 h-3" /> {d.meta.githubCommitMessage}
                        </span>
                        <span className="flex items-center gap-1">
              ...
              <Button
                ...
                onClick={() => {
                  const text = Array.isArray(logs)
                    ? logs.map((l: any) => l.payload?.text || l.text || '').join('\n')
