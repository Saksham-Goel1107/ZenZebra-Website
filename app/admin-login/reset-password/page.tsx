        ...
        <div className="flex min-h-screen items-center justify-center bg-[#050505] relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md p-8 relative z-10 mx-4">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-white/40 mt-2 text-sm">Please enter a strong password for your account</p>
                </div>
                    ...
                    {success ? (
                        <div className="text-center space-y-6 relative z-10 py-4 animate-in fade-in zoom-in-95">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-white/50 text-sm">Your password has been changed successfully. Redirecting to login...</p>
                            </div>
                            <Button
                        ...
                        <form onSubmit={handleReset} className="space-y-5 relative z-10 animate-in fade-in slide-in-from-bottom-4">
                            <div className="space-y-2">
                                <label className="text-xs font-medium uppercase tracking-wider text-white/50 ml-1">New Password</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium uppercase tracking-wider text-white/50 ml-1">Confirm New Password</label>
                                <div className="relative group">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/30 group-focus-within:text-[#CC2224] transition-colors" />
                                    <Input
                                        type={showPassword ? 'text' : 'password'}
...
export default function ResetPasswordPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center"><Loader2 className="w-8 h-8 text-[#CC2224] animate-spin" /></div>}>
            <ResetPasswordForm />
        </Suspense>
    );
}
